...
<h1>This is the profile of <?=$user->first_name?></h1>
	...
	<p><label class="field" for="gender">Gender:</label>
	        ...
	        <input type="radio" id='gender1' name="gender" value='FEMALE' <?if($currentuser['gender']=='FEMALE'):?>checked<?php endif; ?>>Female</p>
	<p><label class="field" for="married">Married:</label>
			<input type='radio' id='married' name='married' value='YES' <?if($currentuser['married']=='YES'):?>checked<?php endif; ?>>Yes
	...
	<p><label class="field" for="city">City:</label>
